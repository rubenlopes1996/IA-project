...
public class StatisticBestInRun<I extends Individual, P extends Problem<I>> implements GAListener {
    ...
    public void experimentEnded(ExperimentEvent e) {
        snake.snakeAI.ga.utils.FileOperations.appendToTextFile("statistic_best_per_experiment_fitness.xls", e.getSource() + "\t" +"Fitnes:" + bestInExperiment.getFitness() + "\r\n");
        snake.snakeAI.ga.utils.FileOperations.appendToTextFile("statistic_best_per_experiment.txt", "\r\n\r\n" + e.getSource() + "\r\n" +"Best Fitness Individual" + bestInExperiment);
    }
}
